...
gsettings set com.canonical.Unity.Lenses home-lens-default-view "['applications.scope', 'applications-applications.scope', 'applications-scopes.scope']"

gsettings set com.canonical.Unity.Lenses home-lens-priority "['applications.scope']"

gsettings set com.canonical.Unity.Lenses disabled-scopes "['more_suggestions-amazon.scope', 'more_suggestions-u1ms.scope', 'more_suggestions-populartracks.scope', 'web.scope', 'more_suggestions.scope','more_suggestions-skimlinks.scope','music-musicstore.scope','more_suggestions-ubuntushop.scope', 'more_suggestions-ebay.scope', 'files.scope', 'music.scope', 'graphics.scope', 'video.scope', 'calendar.scope', 'searchin.scope', 'commands.scope', 'recipes.scope', 'photos.scope', 'books.scope', 'home.scope', 'reference.scope', 'info.scope', 'notes.scope', 'weather.scope', 'code.scope', 'news.scope', 'boxes.scope']"
